...
if ($find !== 1) {
    ...
    <div class="box box-solid box-success">
        <div class="box-header">
            <h3 class=" box-title">
                Cetak Laporan Berdasarkan Usia
            </h3>

            <a class="btn btn-default pull-right" href="<?=GENERAL_MODULE_URL.'cetak_lpbku/pdf.php';?>">
                <i class="fa fa-print"></i> Cetak
            </a>
            <div class="pull-right" style="max-width: 100px">
                <form action="<?=moduleUrlByLevel('cetak/lpbku', 'aksi=filter_data');?>" method="post">
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-5">
                    <div id="statistik-usia" style="min-width: 310px; height: 400px; max-width: 600px; margin: 0 auto"></div>
                    <script type="text/javascript">
                        $(function () {

                            Highcharts.chart('statistik-usia', {
                                chart: {
                                ...
                                series: [{
                                    ...
                                    data: [
                                        ...
                                        $sql = "SELECT usia, jumlah from statistik_data_usia WHERE desa_id IN ('".implode("','", $desaIds)."') group by usia";
                                        $datas = _fetchMultipleFromSql($sql);
                                        foreach($datas as $data)
                                        { ?>
                                        ['<?php echo $data['usia']?>',   <?php echo $data['jumlah']?>],
                                        <?php
                                        }//end while
                                        ?>
                                    ]
