...
switch($_GET[aksi]){
    ...
    <div style="margin-right:10%;margin-left:15%" class="alert alert-success alert-dismissable text-center">
        ...
        <p>
            ...
            "Anda Berada Di Halaman Data Warga"!!!
        </p>
    </div>
...
<div class="box box-solid box-danger">
    <div class="box-header">
        ...
        <a class="btn btn-default pull-right" href="?module=kk&aksi=list_istri">
            <i class="fa  fa-plus"></i> Tambah Data Istri
        </a>
    </div>
	<div class="box-body">
		<!--<a class="btn btn-default pull-right"href="?module=kk&aksi=tambah">
...
<i class="fa fa-book"></i> Data Anak </h3>
	...
	<div class="box-body">
<?php $d=mysql_query("select * from data_anak where  id_ayah='$_GET[id]'");
